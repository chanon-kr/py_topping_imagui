...
def tab2_gen(input_df) :
    ...
    tab2_layout =   [[sg.Text('Setting of py-topping-imagui')]
                    ,[sg.Button('SaveConfig', key = 'UpdateConfig', size=(13, 1), font='Helvetica 14'),
                    #   sg.Button('ReloadConfig', key = 'ReloadConfig', size=(13, 1), font='Any 14')
                      ]
